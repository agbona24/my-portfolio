...
export default function FloatingActions() {
  ...
  const phoneNumber = "+2347069716822";
  const whatsappNumber = "2347069716822";
  const email = "azeez.agbona.o@gmail.com";
  ...
  const contactOptions = [
    {
      ...
      href: `https://wa.me/${whatsappNumber}?text=Hello%20Abdul-Azeez,%20I%20found%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20project%20with%20you.`,
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            exit={{ opacity: 0, y: 20 }}
            onClick={scrollToTop}
            className="fixed left-6 bottom-6 z-50 p-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg hover:shadow-xl transition-shadow"
